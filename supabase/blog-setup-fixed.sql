-- =============================================
-- SETUP DO BLOG INTEGRADO (VERSÃO IDEMPOTENTE)
...
DROP POLICY IF EXISTS "Leitura pública de categorias" ON blog_categories;
DROP POLICY IF EXISTS "Admins podem gerenciar categorias" ON blog_categories;
...
DROP POLICY IF EXISTS "Leitura pública de tags" ON blog_tags;
DROP POLICY IF EXISTS "Admins podem gerenciar tags" ON blog_tags;
...
DROP POLICY IF EXISTS "Leitura pública de posts publicados" ON blog_posts;
DROP POLICY IF EXISTS "Admins podem ver todos posts" ON blog_posts;
DROP POLICY IF EXISTS "Admins podem criar posts" ON blog_posts;
DROP POLICY IF EXISTS "Admins podem editar posts" ON blog_posts;
DROP POLICY IF EXISTS "Admins podem deletar posts" ON blog_posts;
...
DROP POLICY IF EXISTS "Leitura pública de post_tags" ON blog_post_tags;
DROP POLICY IF EXISTS "Admins podem gerenciar post_tags" ON blog_post_tags;
...
-- Remover policies antigas de storage se existirem
DROP POLICY IF EXISTS "Leitura pública de imagens do blog" ON storage.objects;
...
-- Verifique se o bucket "blog-images" foi criado em "Storage"
