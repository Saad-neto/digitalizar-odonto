        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-4">
              <h4 className="font-semibold text-purple-800 mb-2">Horário de atendimento:</h4>
          ...
          <div className="space-y-6">
            ...
            {loadingTimes ? (
              <div className="text-center py-8">
                ...
                <p className="text-purple-600 mt-4">Carregando horários disponíveis...</p>
              </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white border-2 border-purple-200 rounded-xl p-6 space-y-4">
              <div>
                <h4 className="font-semibold text-purple-800 mb-2">Suas informações</h4>
              ...
              <div className="border-t-2 border-purple-100 pt-4">
                <h4 className="font-semibold text-purple-800 mb-2">Data e Horário</h4>
                <p className="text-gray-700">
                  <strong>Data:</strong>{' '}
              ...
              <div className="border-t-2 border-purple-100 pt-4">
                <h4 className="font-semibold text-purple-800 mb-2">Tipo de Reunião</h4>
                <p className="text-gray-700">
              ...
              {formData.observacoes && (
                <div className="border-t-2 border-purple-100 pt-4">
                  <h4 className="font-semibold text-purple-800 mb-2">Observações</h4>
